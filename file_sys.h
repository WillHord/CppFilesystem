...
class inode_state {
   ...
   public:
      ...
      const vector<string> get_pwd() const {return pwd; }
      void set_cwd(inode_ptr);
      void add_pwd(string);
      void remove_pwd();
      void reset_pwd();
      void set_pwd(vector<string>);

      void clearDir(inode_ptr);
};
...
class inode {
   ...
   public:
      ...
      base_file_ptr getFilePtr() {return contents;}
};
...
class base_file {
   ...
   public:
      ...
      virtual string isDirectory() {return file_type();}
};
// class plain_file -
// Used to hold data.
